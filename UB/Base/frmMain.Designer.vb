...
Partial Class frmMain
    ...
    Private Sub InitializeComponent()
        ...
        Me.RibbonPageGroup35.Text = "RibbonPageGroup35"
        '
        'ProvinceBar
        '
