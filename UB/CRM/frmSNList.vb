...
#Region "Private"
    ...
    Private Function LoadData() As Boolean
        ...
        Try
            ...
            SQL &= "   LEFT OUTER JOIN Orders AS INV ON INV.OrderID=(select max(OrderID)   from OrdersRef where OrdersRef.IsDelete=0 and OrdersRef.RefOrderID=PO.OrderID  ) and INV.IsDelete=0 and INV.TableID=58 "
    ...
    Private Sub GridStyle()
        With gridView
            ...
            .Columns("INVCODE").Caption = "เลขที่ใบกำกับภาษีซื้อ"
            .Columns("INVCODE").Width = 80
