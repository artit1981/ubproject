...
Public Class frmCreditRole

    Inherits iEditForm
    Private Const mFormName As String = "frmCreditRole"
    Dim mcls As New CreditRoleDAO
...
#Region "Overrides"
    ...
    Protected Overrides Function Save(ByVal pMode As Integer, ByVal pID As Long) As Boolean
        ...
        Try
            ...
            mcls.CreditDay = ConvertNullToZero(txtCreditDay.EditValue)
...
#Region "Private"
        ...
        Try
            ...
            ElseIf pMode = DataMode.ModeEdit Then
                If mcls.InitailData(pID, "") Then
                    ...
                    txtCreditDay.EditValue = mcls.CreditDay
    ...
    Private Function Verify() As Boolean
        ...
        Try
            ...
            If ConvertNullToZero(txtCreditDay.EditValue) < 0 Then
