...
Public Class frmBankAccount
    Inherits iEditForm
    Private Const mFormName As String = "frmBankAccount"
    Dim mcls As New BankAccountDAO
...
#Region "Overrides"
    ...
    Protected Overrides Function Save(ByVal pMode As Integer, ByVal pID As Long) As Boolean
        ...
        Try
            ...
            mcls.BankAccountNo = txtNameThai.Text.Trim
            mcls.BankID = ConvertNullToZero(BankID.EditValue)
...
#Region "Private"
        ...
        Try
            ...
            ElseIf pMode = DataMode.ModeEdit Then
                If mcls.InitailData(pID, Nothing) Then
                    ...
                    txtNameThai.Text = mcls.BankAccountNo
    ...
    Private Function Verify() As Boolean
        ...
        Try
            ...
            If ConvertNullToZero(BankID.EditValue) = 0 Then
                SetErrorProvider(DxErrorProvider1, BankID, "กรุณาระบุข้อมูล")
            End If
