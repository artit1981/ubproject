...
#End Region
    ...
    Public Function SaveData() As Boolean
        ...
        Try
            ...
            SQL = SQL & " ,AddressBill,AddressShip,CreditRule,SendBy,Employee"
            SQL = SQL & " ,Total,DiscountPercen,DiscountAmount,VatPercen,VatAmount,GrandTotal,GrandTotalSTR,Remark"
            SQL = SQL & " ,CompanyAddress,CompanyPhone,CompanyFAX,CustomerPhone,CustomerFAX,CompanyTax,CompanyBranch,Header1,Header2,Header3"
            SQL = SQL & " ,CompanyOwner,CompanyMail,CompanyWeb,CustomerType,ShipingRule,QuotationDays,ContactPerson,ShipingMethod,CustomerTax,IsMainCompany"
            SQL = SQL & " ,Institute, RefOrderCode,EmployeePhone,CompanyBankAccount,EmployeePosition "
            SQL = SQL & " )"
            ...
            SQL = SQL & " ,  @Employee"
            SQL = SQL & " ,  @Total "
            SQL = SQL & " ,  @DiscountPercen "
            SQL = SQL & " ,  @DiscountAmount "
            SQL = SQL & " ,  @VatPercen "
            SQL = SQL & " ,  @VatAmount "
            SQL = SQL & " ,  @GrandTotal "
            SQL = SQL & " ,  @GrandTotalSTR "
            SQL = SQL & " ,  @Remark "
            SQL = SQL & " ,  @CompanyAddress "
            SQL = SQL & " ,  @CompanyPhone "
            SQL = SQL & " ,  @CompanyFAX "
            SQL = SQL & " ,  @CustomerPhone "
            SQL = SQL & " ,  @CustomerFAX "
            SQL = SQL & " ,  @CompanyTax "
            SQL = SQL & " ,  @CompanyBranch "
            SQL = SQL & " ,  @Header1 "
            SQL = SQL & " ,  @Header2 "
            SQL = SQL & " ,  @Header3 "
            SQL = SQL & " ,  @CompanyOwner "
            SQL = SQL & " ,  @CompanyMail "
            SQL = SQL & " ,  @CompanyWeb "
            SQL = SQL & " ,  @CustomerType "
            SQL = SQL & " ,  @ShipingRule "
            SQL = SQL & " ,  @QuotationDays "
            SQL = SQL & " ,  @ContactPerson "
            SQL = SQL & " ,  @ShipingMethod "
            SQL = SQL & " ,  @CustomerTax "
