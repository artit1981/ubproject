...
Public Class CreditRoleDAO
    Inherits iDAO
    Dim mCreditDay As Long
    ...
    Public ReadOnly Property ClassName() As String
        Get
            Return "CreditRoleDAO"
        End Get
    End Property

    Public Property CreditDay() As Long
        Get
            Return mCreditDay
        End Get
        ...
        Try
            ...
            If dataTable.Rows.Count > 0 Then
                For Each dr As DataRow In dataTable.Rows
                    ...
                    Code = dr("CreditRoleCode").ToString.Trim
                    NameThai = dr("NameThai").ToString.Trim
                    NameEng = dr("NameEng").ToString
                    Remark = dr("Remark").ToString
                    CreditDay = ConvertNullToZero(dr("CreditDay"))
    ...
    Public Function SaveData() As Boolean
        ...
        Try
            ...
            myCommand.Parameters.Add(New SqlParameter("@CreditDay", CreditDay))
            myCommand.Parameters.Add(New SqlParameter("@CreditRoleCode", Trim(Code)))
