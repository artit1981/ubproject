...
#End Region
    ...
    Public Function InitailData(ByVal pHistoryID As Long, ByRef tr As SqlTransaction) As Boolean
        ...
        Try
            ...
            SQL = SQL & " WHERE HistoryID =" & pHistoryID
        ...
        Try
            ...
            Select Case mMode
                Case DataMode.ModeNew
                    ...
                    SQL = SQL & " ,Gender,BirthDate,Height,Weight,BloodGroups,Race,Nationality,Religion,TaxID,MaritalStatus"
                    SQL = SQL & " ,MaritalName,MilitaryStatus,IsDelete )"
                    SQL = SQL & " VALUES ( @mIDs"
                    SQL = SQL & " ,  @ImageID "
                    SQL = SQL & " ,  @IdentityCard "
                    SQL = SQL & " ,  @IdentityCardIssueAt "
                    SQL = SQL & " ,  @IdentityCardDate "
                    SQL = SQL & " ,  @IdentityCardExpire "
                    SQL = SQL & " ,  @Gender "
                    SQL = SQL & " ,  @BirthDate "
                    SQL = SQL & " ,  @Height "
                    SQL = SQL & " ,  @Weight "
                    ...
                    SQL = SQL & " ,  @MaritalName "
                    SQL = SQL & " ,  @MilitaryStatus "
                    SQL = SQL & " ,  @mIsDelete "
                    SQL = SQL & " ) "
                Case DataMode.ModeEdit
                    SQL = " UPDATE History "
                    SQL = SQL & " SET IdentityCard=@IdentityCard "
                    SQL = SQL & " ,IdentityCardIssueAt=@IdentityCardIssueAt "
                    SQL = SQL & " ,IdentityCardDate=@IdentityCardDate "
                    SQL = SQL & " ,IdentityCardExpire=@IdentityCardExpire "
                    SQL = SQL & " ,Gender=@Gender  "
                    SQL = SQL & " ,BirthDate=@BirthDate  "
                    SQL = SQL & " ,Height=@Height  "
                    SQL = SQL & " ,Weight=@Weight  "
                    SQL = SQL & " ,BloodGroups=@BloodGroups  "
                    SQL = SQL & " ,Race=@Race  "
                    SQL = SQL & " ,Nationality=@Nationality  "
                    SQL = SQL & " ,Religion=@Religion  "
                    SQL = SQL & " ,TaxID=@TaxID  "
                    SQL = SQL & " ,MaritalStatus=@MaritalStatus  "
                    SQL = SQL & " ,MaritalName=@MaritalName  "
                    SQL = SQL & " ,MilitaryStatus=@MilitaryStatus  "
                    SQL = SQL & " ,ImageID  =@ImageID "
                    SQL = SQL & " WHERE HistoryID= @mIDs"
