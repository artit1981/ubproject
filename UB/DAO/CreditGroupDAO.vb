...
Public Class CreditGroupDAO
        ...
        Try
            ...
            If dataTable.Rows.Count > 0 Then
                For Each dr As DataRow In dataTable.Rows
                    ...
                    Code = dr("CreditGroupCode").ToString.Trim
    ...
    Public Function SaveData() As Boolean
        ...
        Try
            ...
            myCommand.Parameters.Add(New SqlParameter("@CreditAmount", CreditAmount))
            myCommand.Parameters.Add(New SqlParameter("@CreditGroupCode", Trim(Code)))
