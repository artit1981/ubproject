...
Public Class VatTypeDAO
    ...
    Public Function InitailData(ByVal pID As Long, ByVal pCode As String) As Boolean
        Dim SQL As String
        Dim dataTable As New DataTable()
        ...
        Try
            ...
            SQL = SQL & " WHERE 1=1 "
            If pID > 0 Then
                SQL = SQL & " and VatTypeID=" & pID
            End If
            If pCode <> "" Then
                SQL = SQL & " and VatTypeCode like '%" & pCode & "%'"
            End If
            ...
            If dataTable.Rows.Count > 0 Then
                For Each dr As DataRow In dataTable.Rows
                    ...
                    Code = dr("VatTypeCode").ToString.Trim
                    NameThai = dr("NameThai").ToString.Trim
                    NameEng = dr("NameEng").ToString
                    Remark = dr("Remark").ToString
                    VatRate = ConvertNullToZero(dr("VatRate"))
                    VatType = ConvertNullToString(dr("VatType"))
    ...
    Public Function GetDataTable(ByVal pID As Long, ByVal pOnlyActive As Boolean) As DataTable
        ...
        Try
            SQL = "SELECT VatTypeID AS ID,VatTypeCode AS Code,NameThai,VatRate"
            SQL = SQL & " FROM VatType  "
            ...
            End If
            SQL = SQL & " ORDER BY VatTypeCode,NameThai "
            dataTable = gConnection.executeSelectQuery(SQL, Nothing)
        Catch e As Exception
        ...
        Try
            ...
            Select Case ModeData
                Case DataMode.ModeNew
                    ...
                    SQL = " INSERT INTO " & TableName & "(VatTypeID,VatType,VatRate,VatTypeCode,NameThai,NameEng,Remark"
                ...
                Case DataMode.ModeEdit
                    ...
                    SQL = SQL & " VatType=@VatType"
                    SQL = SQL & " ,VatRate=@VatRate"
                    SQL = SQL & " ,VatTypeCode=@VatTypeCode"
            ...
            myCommand.Parameters.Add(New SqlParameter("@VatRate", VatRate))
            myCommand.Parameters.Add(New SqlParameter("@VatType", Trim(VatType)))
            myCommand.Parameters.Add(New SqlParameter("@VatTypeCode", Trim(Code)))
    ...
    Public Function CheckExist() As Boolean
        ...
        Try
            ...
            SQL = SQL & " WHERE IsDelete =0 AND NameThai='" & Trim(Code) & "'"
