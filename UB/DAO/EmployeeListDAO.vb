...
Public Class EmployeeListDAO
    ...
    Public Overrides Function InitailData(ByVal pID As Long, Optional ByVal pName As String = "", Optional ByVal tr As SqlTransaction = Nothing) As Boolean
        ...
        '    Err.Raise(Err.Number, e.Source, "EmployeeListDAO.InitailData : " & e.Message)
        '    Return False
        'Finally
        '    lUserDAO = Nothing
        '    dataTable = Nothing
    ...
    Public Overrides Function SaveData(Optional ByRef ptr As SqlTransaction = Nothing) As Boolean
        ...
        Try
            ...
            myCommand.Parameters.Add(New SqlParameter("@mEmpID", EmpID))
            gConnection.executeInsertSqlCommand(myCommand, ptr)
            Return True
        Catch e As Exception
            Err.Raise(Err.Number, e.Source, "EmployeeListDAO.SaveData : " & e.Message)
            Return False
        End Try
    End Function
