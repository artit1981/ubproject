...
#End Region
    ...
    Public Function InitailData(ByVal pAdressID As Long, ByRef tr As SqlTransaction) As Boolean
        ...
        Try
            ...
            SQL = SQL & " WHERE AddressID =" & pAdressID
        ...
        Try
            Select Case mMode
                Case DataMode.ModeNew
                    ...
                    SQL = SQL & " ,Amphur,Province,PostalCode,Country,ContactName,MobilePhone "
                    SQL = SQL & " ,Phone1,Phone2,Phone3,Fax,Email1,Email2,Email3,Website,ImageID,Remark,IsDelete )"
                    SQL = SQL & " VALUES ( @mIDs"
                    SQL = SQL & " ,  @AddressName "
                    SQL = SQL & " ,  @AddressNo "
                    SQL = SQL & " ,  @GroupNo "
                ...
                Case DataMode.ModeEdit
                    SQL = " UPDATE Address "
                    SQL = SQL & " SET AddressName=@AddressName "
                    SQL = SQL & " ,AddressNo=@AddressNo "
                    SQL = SQL & " ,GroupNo  =@GroupNo "
                    SQL = SQL & " ,Building  =@Building "
                    SQL = SQL & " ,Lane  =@Lane "
                    SQL = SQL & " ,Street  =@Street "
                    SQL = SQL & " ,District  =@District "
                    SQL = SQL & " ,Amphur  =@Amphur "
                    SQL = SQL & " ,Province  =@Province "
                    SQL = SQL & " ,PostalCode  =@PostalCode "
                    SQL = SQL & " ,Country  =@Country "
                    SQL = SQL & " ,ContactName  =@ContactName "
                    SQL = SQL & " ,MobilePhone  =@MobilePhone "
