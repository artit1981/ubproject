...
Public Class frmOpportunityStage
    Inherits iEditForm
    Private Const mFormName As String = "frmOpportunityStage"
    Dim mcls As New OpportunityStageDAO
...
#Region "Overrides"
    ...
    Protected Overrides Function Save(ByVal pMode As Integer, ByVal pID As Long) As Boolean
        ...
        Try
            ...
            mcls.Percents = ConvertNullToZero(txtPercents.EditValue)
...
#Region "Private"
        ...
        Try
            ...
            ElseIf pMode = DataMode.ModeEdit Then
                If mcls.InitailData(pID) Then
                    ...
                    txtPercents.EditValue = mcls.Percents
    ...
    Private Function Verify() As Boolean
        ...
        Try
            ...
            If Trim(txtPercents.Text) = "" Then
                SetErrorProvider(DxErrorProvider1, txtPercents, "กรุณาระบุข้อมูล")
            ElseIf ConvertNullToZero(txtPercents.Text) < 0 Then
                SetErrorProvider(DxErrorProvider1, txtPercents, "กรุณาระบุข้อมูลมากว่า หรือเท่ากับ 0")
            End If
