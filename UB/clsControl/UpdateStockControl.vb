...
Public Class UpdateStockControl
    Implements iControl
    Private Const mCaption As String = "ปรับยอดสินค้า"
    ...
    Private Sub LoadData()
        Dim lcls As New UpdateStockDAO
        ...
        Try
            ...
            End If
            dataTable = lcls.GetDataTable(0, False, SQL)
        ...
        Catch e As Exception
            Err.Raise(Err.Number, e.Source, "UpdateStockControl.LoadData : " & e.Message)
        Finally
            lcls = Nothing
            dataTable = Nothing
        End Try
    ...
    Private Sub mCtlForm_AddNew() Handles mCtlForm.AddNew
        ...
        Catch ex As Exception
            Err.Raise(Err.Number, ex.Source, "UpdateStockControl.mCtlForm_AddNew : " & ex.Message)
        End Try
    End Sub
    ...
    Private Sub ShowForm(ByVal pMode As Integer, ByVal pID As Long)
        ...
        Try
            With lFormEdit
                ...
                .ModeData = pMode
                .IDs = pID
                .OrderType = MasterType.UpdateStock
                .Show()
            End With

        Catch ex As Exception
            Err.Raise(Err.Number, ex.Source, "UpdateStockControl.ShowForm : " & ex.Message)
        End Try
    End Sub
    ...
    Private Sub mCtlForm_CHeckRefresh() Handles mCtlForm.CHeckRefresh
        ...
        Try
            ...
            End If
        Catch e As Exception
            Err.Raise(Err.Number, e.Source, "UpdateStockControl.mCtlForm_CHeckRefresh : " & e.Message)
        Finally
            lcls = Nothing
        End Try
    End Sub
    ...
    Private Sub mCtlForm_Copy(ByVal pID As Long) Handles mCtlForm.Copy
        ...
        Catch ex As Exception
            Err.Raise(Err.Number, ex.Source, "UpdateStockControl.mCtlForm_Copy : " & ex.Message)
        End Try
    End Sub
    ...
    Private Sub mCtlForm_Delete(ByVal pID As Long) Handles mCtlForm.Delete
        ...
        Try
            ...
            End If
        Catch ex As Exception
            Err.Raise(Err.Number, ex.Source, "UpdateStockControl.mCtlForm_Delete : " & ex.Message)
        Finally
            lcls = Nothing
        End Try
    End Sub
    ...
    Private Sub mCtlForm_Edit(ByVal pID As Long) Handles mCtlForm.Edit
        ...
        Catch ex As Exception
            Err.Raise(Err.Number, ex.Source, "UpdateStockControl.mCtlForm_Edit : " & ex.Message)
        End Try
    End Sub
    ...
    Private Sub mCtlForm_InitDetail(ByVal pID As Long) Handles mCtlForm.InitDetail
        ...
        '    End If
        'Catch ex As Exception
        '    Err.Raise(Err.Number, ex.Source, "UpdateStockControl.mCtlForm_InitDetail : " & ex.Message)
        'Finally
        '    lclsLeadDAO = Nothing
        'End Try
    End Sub
    ...
    Private Sub mCtlForm_InitStatus(ByVal pID As Long) Handles mCtlForm.InitStatus
        ...
        '    End If
        'Catch ex As Exception
        '    Err.Raise(Err.Number, ex.Source, "UpdateStockControl.mCtlForm_InitStatus : " & ex.Message)
        'Finally
        '    lcls = Nothing
        'End Try
    End Sub
    ...
    Private Sub mCtlForm_RefreshFind() Handles mCtlForm.RefreshFind
        ...
        Catch ex As Exception
            Err.Raise(Err.Number, ex.Source, "UpdateStockControl.mCtlForm_ReLoad : " & ex.Message)
        End Try
    End Sub
