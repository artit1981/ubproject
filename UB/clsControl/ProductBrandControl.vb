...
Public Class ProductBrandControl
    ...
    Private Sub LoadFilter()
        mFindAll(0) = "ทั้งหมด"
        mFindAll(1) = "*"
        mFindCode(0) = "รหัสยี่ห้อสินค้า"
        mFindCode(1) = "IDCode"
        mFindName(0) = "ชื่อยี่ห้อสินค้า"
    ...
    Private Sub GridStyle()
        With mCtlForm.GridView
            ...
            .Columns("ID").Width = 0
            .Columns("ID").Caption = "รหัสยี่ห้อสินค้า"
            .Columns("ID").Visible = False

            .Columns("IDCode").Caption = "รหัสยี่ห้อสินค้า"
            .Columns("IDCode").Width = 400

            .Columns("NameThai").Caption = "ชื่อยี่ห้อสินค้า"
    ...
    Private Sub ShowForm(ByVal pMode As Integer, ByVal pID As Long)
        Dim lFormEdit As frmProductBrand
        Try
            lFormEdit = New frmProductBrand
            With lFormEdit
                .Caption = mCaption
                .MdiParent = frmMain
                .ModeData = pMode
