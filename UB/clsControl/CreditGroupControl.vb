...
Public Class CreditGroupControl
    Implements iControl
    Private Const mCaption As String = "กลุ่มวงเงิน"
    ...
    Private Sub LoadData()
        ...
        Catch e As Exception
            Err.Raise(Err.Number, e.Source, "CreditGroupControl.LoadData : " & e.Message)
        Finally
            lcls = Nothing
            dataTable = Nothing
        End Try
    ...
    Private Sub LoadFilter()
        mFindAll(0) = "ทั้งหมด"
        mFindAll(1) = "*"
        mFindCode(0) = "รหัสกลุ่มวงเงิน"
        mFindCode(1) = "CreditGroupCode"
        mFindName(0) = "ชื่อกลุ่มวงเงิน"
        ...
        Catch e As Exception
            Err.Raise(Err.Number, e.Source, "CreditGroupControl.LoadFilter : " & e.Message)
        Finally
        End Try
    End Sub
    ...
    Private Sub GridStyle()
        With mCtlForm.GridView
            ...
            .Columns("CreditGroupCode").Caption = "รหัสกลุ่มวงเงิน"
            .Columns("CreditGroupCode").Width = 400

            .Columns("NameThai").Caption = "ชื่อกลุ่มวงเงิน"
            .Columns("NameThai").Width = 700

            .Columns("CreditAmount").Caption = "วงเงิน"
            .Columns("CreditAmount").Width = 100
            .Columns("CreditAmount").DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
            .Columns("CreditAmount").DisplayFormat.FormatString = "n2"
    ...
    Private Sub mCtlForm_AddNew() Handles mCtlForm.AddNew
        ...
        Catch ex As Exception
            Err.Raise(Err.Number, ex.Source, "CreditGroupControl.mCtlForm_AddNew : " & ex.Message)
        End Try
    End Sub

    Private Sub ShowForm(ByVal pMode As Integer, ByVal pID As Long)
        Dim lFormEdit As frmCreditGroup
        Try
            lFormEdit = New frmCreditGroup
            With lFormEdit
                .Caption = mCaption
                .MdiParent = frmMain
                .ModeData = pMode
        ...
        Catch ex As Exception
            Err.Raise(Err.Number, ex.Source, "CreditGroupControl.ShowForm : " & ex.Message)
        End Try
    End Sub
    ...
    Private Sub mCtlForm_CHeckRefresh() Handles mCtlForm.CHeckRefresh
        ...
        Try
            ...
            End If
        Catch e As Exception
            Err.Raise(Err.Number, e.Source, "CreditGroupControl.mCtlForm_CHeckRefresh : " & e.Message)
        Finally
            lcls = Nothing
        End Try
    End Sub
    ...
    Private Sub mCtlForm_Delete(ByRef pID As Long) Handles mCtlForm.Delete
        ...
        Try
            ...
            End If
        Catch ex As Exception
            Err.Raise(Err.Number, ex.Source, "CreditGroupControl.mCtlForm_Delete : " & ex.Message)
        Finally
            lcls = Nothing
        End Try
    End Sub
    ...
    Private Sub mCtlForm_Edit(ByVal pID As Long) Handles mCtlForm.Edit
        ...
        Catch ex As Exception
            Err.Raise(Err.Number, ex.Source, "CreditGroupControl.mCtlForm_Edit : " & ex.Message)
        End Try
    End Sub

    Private Sub mCtlForm_InitDetail(ByVal pID As Long) Handles mCtlForm.InitDetail
        Dim lclsDepartmentDAO As New CreditGroupDAO
        ...
        Try
            ...
            End If
        Catch ex As Exception
            Err.Raise(Err.Number, ex.Source, "CreditGroupControl.mCtlForm_InitDetail : " & ex.Message)
        Finally
    ...
    Private Sub mCtlForm_RefreshFind() Handles mCtlForm.RefreshFind
        ...
        Catch ex As Exception
            Err.Raise(Err.Number, ex.Source, "CreditGroupControl.mCtlForm_ReLoad : " & ex.Message)
        End Try
    End Sub
