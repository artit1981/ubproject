...
Public Class PositionControl
    Implements iControl
    Private Const mCaption As String = "ตำแหน่ง"
    ...
    Private Sub LoadFilter()
        mFindAll(0) = "ทั้งหมด"
        mFindAll(1) = "*"
        mFindCode(0) = "รหัสตำแหน่ง"
        mFindCode(1) = "IDCode"
        mFindName(0) = "ชื่อตำแหน่ง"
    ...
    Private Sub GridStyle()
        With mCtlForm.GridView
            ...
            .Columns("ID").Width = 0
            .Columns("ID").Caption = "รหัสตำแหน่ง"
            .Columns("ID").Visible = False

            .Columns("IDCode").Caption = "รหัสตำแหน่ง"
            .Columns("IDCode").Width = 400

            .Columns("NameThai").Caption = "ชื่อตำแหน่ง"
    ...
    Private Sub mCtlForm_InitDetail(ByVal pID As Long) Handles mCtlForm.InitDetail
        Dim lclsDAO As New PositionDAO
