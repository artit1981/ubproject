...
Public Class BankControl
    ...
    Private Sub LoadData()
        ...
        Catch e As Exception
            Err.Raise(Err.Number, e.Source, "BankControl.LoadData : " & e.Message)
        Finally
            lcls = Nothing
            dataTable = Nothing
        End Try
    ...
    Private Sub LoadFilter()
        mFindAll(0) = "ทั้งหมด"
        mFindAll(1) = "*"
        mFindCode(0) = "รหัสธนาคาร"
        mFindCode(1) = "Code"
        mFindName(0) = "ชื่อธนาคาร"
        ...
        Catch e As Exception
            Err.Raise(Err.Number, e.Source, "BankControl.LoadFilter : " & e.Message)
        Finally
        End Try
    End Sub
    ...
    Private Sub GridStyle()
        With mCtlForm.GridView
            ...
            .Columns("Code").Caption = "รหัสธนาคาร"
    ...
    Private Sub mCtlForm_AddNew() Handles mCtlForm.AddNew
        ...
        Catch ex As Exception
            Err.Raise(Err.Number, ex.Source, "BankControl.mCtlForm_AddNew : " & ex.Message)
        End Try
    End Sub

    Private Sub ShowForm(ByVal pMode As Integer, ByVal pID As Long)
        Dim lFormEdit As frmBank
        Try
            lFormEdit = New frmBank
            With lFormEdit
                .Caption = mCaption
                .MdiParent = frmMain
                .ModeData = pMode
        ...
        Catch ex As Exception
            Err.Raise(Err.Number, ex.Source, "BankControl.ShowForm : " & ex.Message)
        End Try
    End Sub
    ...
    Private Sub mCtlForm_CHeckRefresh() Handles mCtlForm.CHeckRefresh
        ...
        Try
            ...
            End If
        Catch e As Exception
            Err.Raise(Err.Number, e.Source, "BankControl.mCtlForm_CHeckRefresh : " & e.Message)
        Finally
            lcls = Nothing
        End Try
    End Sub
    ...
    Private Sub mCtlForm_Delete(ByRef pID As Long) Handles mCtlForm.Delete
        ...
        Try
            ...
            End If
        Catch ex As Exception
            Err.Raise(Err.Number, ex.Source, "BankControl.mCtlForm_Delete : " & ex.Message)
        Finally
            lcls = Nothing
        End Try
    End Sub
    ...
    Private Sub mCtlForm_Edit(ByVal pID As Long) Handles mCtlForm.Edit
        ...
        Catch ex As Exception
            Err.Raise(Err.Number, ex.Source, "BankControl.mCtlForm_Edit : " & ex.Message)
        End Try
    End Sub

    Private Sub mCtlForm_InitDetail(ByVal pID As Long) Handles mCtlForm.InitDetail
        Dim lclsDepartmentDAO As New BankDAO
        ...
        Try
            ...
            End If
        Catch ex As Exception
            Err.Raise(Err.Number, ex.Source, "BankControl.mCtlForm_InitDetail : " & ex.Message)
        Finally
    ...
    Private Sub mCtlForm_RefreshFind() Handles mCtlForm.RefreshFind
        ...
        Catch ex As Exception
            Err.Raise(Err.Number, ex.Source, "BankControl.mCtlForm_ReLoad : " & ex.Message)
        End Try
    End Sub
