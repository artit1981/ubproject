...
Public Class InformPriceControl
    Implements iControl
    Private Const mCaption As String = "ระบบแจ้งราคา"
    ...
    Public Sub Execute(ByVal pOrderType As Integer) Implements iControl.Execute
        Try
            ...
            With mCtlForm
                ...
                Call LoadData()
                Call InitialFilterCon(mCtlForm.cboFindIn, FilterBy.Customer) 'Call Global function
                Call SetControlMenuPrivilege(mCtlForm, MasterType.InformPrice)
                .Show()
            End With
    ...
    Private Sub ShowForm(ByVal pMode As Integer, ByVal pID As Long)
        Dim lFormEdit As frmInformPrice
        Try
            lFormEdit = New frmInformPrice
            With lFormEdit
                .Caption = mCaption
                '.MdiParent = frmMain
                .ModeData = pMode
