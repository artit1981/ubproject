...
Public Class ProductTypeControl
    Implements iControl
    Private Const mCaption As String = "ประเภทสินค้า"
    ...
    Private Sub LoadData()
        ...
        Try
            ...
            dataTable = lcls.GetDataTable(0, False, 0)
        ...
        Catch e As Exception
            Err.Raise(Err.Number, e.Source, "ProductBrandControl.LoadData : " & e.Message)
        Finally
            lcls = Nothing
            dataTable = Nothing
        End Try
    ...
    Private Sub LoadFilter()
        mFindAll(0) = "ทั้งหมด"
        mFindAll(1) = "*"
        mFindCode(0) = "รหัสประเภทสินค้า"
        mFindCode(1) = "IDCode"
        mFindName(0) = "ชื่อประเภทสินค้า"
        ...
        Catch e As Exception
            Err.Raise(Err.Number, e.Source, "ProductBrandControl.LoadFilter : " & e.Message)
        Finally
        End Try
    End Sub
    ...
    Private Sub GridStyle()
        With mCtlForm.GridView
            ...
            .Columns("ID").Width = 0
            .Columns("ID").Caption = "รหัสประเภทสินค้า"
            .Columns("ID").Visible = False

            .Columns("IDCode").Caption = "รหัสประเภทสินค้า"
            .Columns("IDCode").Width = 400

            .Columns("NameThai").Caption = "ชื่อประเภทสินค้า"
    ...
    Private Sub mCtlForm_AddNew() Handles mCtlForm.AddNew
        ...
        Catch ex As Exception
            Err.Raise(Err.Number, ex.Source, "ProductBrandControl.mCtlForm_AddNew : " & ex.Message)
        End Try
    End Sub

    Private Sub ShowForm(ByVal pMode As Integer, ByVal pID As Long)
        Dim lFormEdit As frmProductType
        Try
            lFormEdit = New frmProductType
            With lFormEdit
                .Caption = mCaption
                .MdiParent = frmMain
                .ModeData = pMode
        ...
        Catch ex As Exception
            Err.Raise(Err.Number, ex.Source, "ProductBrandControl.ShowForm : " & ex.Message)
        End Try
    End Sub
    ...
    Private Sub mCtlForm_CHeckRefresh() Handles mCtlForm.CHeckRefresh
        ...
        Try
            ...
            End If
        Catch e As Exception
            Err.Raise(Err.Number, e.Source, "ProductBrandControl.mCtlForm_CHeckRefresh : " & e.Message)
        Finally
            lcls = Nothing
        End Try
    End Sub
    ...
    Private Sub mCtlForm_Delete(ByRef pID As Long) Handles mCtlForm.Delete
        ...
        Catch ex As Exception
            Err.Raise(Err.Number, ex.Source, "ProductBrandControl.mCtlForm_Delete : " & ex.Message)
        Finally
            lcls = Nothing
        End Try
    End Sub
    ...
    Private Sub mCtlForm_Edit(ByVal pID As Long) Handles mCtlForm.Edit
        ...
        Catch ex As Exception
            Err.Raise(Err.Number, ex.Source, "ProductBrandControl.mCtlForm_Edit : " & ex.Message)
        End Try
    End Sub
    ...
    Private Sub mCtlForm_InitDetail(ByVal pID As Long) Handles mCtlForm.InitDetail
        ...
        Try
            ...
            End If
        Catch ex As Exception
            Err.Raise(Err.Number, ex.Source, "ProductBrandControl.mCtlForm_InitDetail : " & ex.Message)
        Finally
            lcls = Nothing
        End Try
    End Sub
    ...
    Private Sub mCtlForm_RefreshFind() Handles mCtlForm.RefreshFind
        ...
        Catch ex As Exception
            Err.Raise(Err.Number, ex.Source, "ProductBrandControl.mCtlForm_ReLoad : " & ex.Message)
        End Try
    End Sub
