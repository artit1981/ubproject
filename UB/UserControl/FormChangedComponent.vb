...
Public Class FormChangedComponent
...
#Region "Public interface"
    ...
    Private Function GetChangeEventName(ByVal ctl As Control) As String
        If TypeOf (ctl) Is TextBox Or TypeOf (ctl) Is DevExpress.XtraEditors.TextEdit _
                  Or TypeOf (ctl) Is DevExpress.XtraEditors.CalcEdit _
                  Or TypeOf (ctl) Is DevExpress.XtraEditors.MemoEdit Then
            Return "TextChanged"
        ElseIf TypeOf (ctl) Is CheckBox Or TypeOf (ctl) Is DevExpress.XtraEditors.CheckEdit Then
            Return "CheckedChanged"
        ElseIf TypeOf (ctl) Is ComboBox Or TypeOf (ctl) Is DevExpress.XtraEditors.LookUpEdit _
                Or TypeOf (ctl) Is DevExpress.XtraEditors.ComboBoxEdit Then
            Return "SelectedValueChanged"
        ElseIf TypeOf (ctl) Is DateTimePicker Or TypeOf (ctl) Is DevExpress.XtraEditors.DateEdit Then
            Return "ValueChanged"
        Else
...
#Region "Public constructors"
        Public Sub New(ByVal ctlIn As Control, ByVal MonitorIn As Boolean)
            _ctlToMonitor = ctlIn
            If TypeOf (ctlIn) Is TextBox Or TypeOf (ctlIn) Is DevExpress.XtraEditors.TextEdit _
                  Or TypeOf (ctlIn) Is DevExpress.XtraEditors.CalcEdit _
                  Or TypeOf (ctlIn) Is DevExpress.XtraEditors.MemoEdit Then
                _ChangeEventName = "TextChanged"
                _ValueName = "Text"
            ElseIf TypeOf (ctlIn) Is CheckBox Then
                _ChangeEventName = "CheckedChanged"
                _ValueName = "Checked"
            ElseIf TypeOf (ctlIn) Is DevExpress.XtraEditors.CheckEdit Then
                _ChangeEventName = "CheckedChanged"
                _ValueName = "Checked"
            ElseIf TypeOf (ctlIn) Is ComboBox Or TypeOf (ctlIn) Is DevExpress.XtraEditors.LookUpEdit _
                Or TypeOf (ctlIn) Is DevExpress.XtraEditors.ComboBoxEdit Then
                _ChangeEventName = "SelectedValueChanged"
                _ValueName = "SelectedValue"
            ElseIf TypeOf (ctlIn) Is DateTimePicker Or TypeOf (ctlIn) Is DevExpress.XtraEditors.DateEdit Then
